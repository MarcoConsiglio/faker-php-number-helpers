...
![Static Badge](https://img.shields.io/badge/84%25-rgb(40%2C%20167%2C%2069)?label=Branch%20coverage&labelColor=rgb(255%2C255%2C255))
![Static Badge](https://img.shields.io/badge/49%25-rgb(166%2C38%2C51)?label=Path%20coverage&labelColor=rgb(255%2C255%2C255))
...
## Examples
```php
$number_1 = $this->negativeRandomFloatStrict(min: 10.0, max: 30.0); // (float) -14.5346
